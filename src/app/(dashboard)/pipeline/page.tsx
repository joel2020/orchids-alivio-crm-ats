...
import { Briefcase, Users, Calendar, Building2, TrendingUp, ArrowRight } from "lucide-react"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { Button } from "@/components/ui/button"
import { APPLICATION_STAGES, ApplicationStage } from "@/lib/types"
...
export default function PipelinePage() {
  ...
  async function fetchStats() {
    const [jobsRes, candidatesRes, appsRes, clientsRes, interviewsRes] = await Promise.all([
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Overview of your recruiting pipeline and activity</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/interviews"><Button variant="outline"><Calendar className="mr-2 h-4 w-4" />Schedule Interview</Button></Link>
          </div>
        </CardContent>
      </Card>
    </div>
